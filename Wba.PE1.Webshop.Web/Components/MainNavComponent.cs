    ...
    public class MainNavComponent : ViewComponent
    {
        ...
        public MainNavComponent()
        {
            publicLinks = new List<MainNavLinkVM>
            {
                ...
                new MainNavLinkVM{ Area=null, Controller="Category", Action="ShowCategories", Text="All Categories"},
                new MainNavLinkVM{ Area=null, Controller="Brand", Action="ShowBrands", Text="All Brands"}
            };
        }
